  ...
  return (
    <div className=" mt-10 ">
      ...
      <div className="flex justify-content flex-wrap">
        <div>
          <figure class="max-w-screen-md mb-5">
            ...
            <blockquote>
              <p class=" font-semibold text-gray-700 dark:text-white">
                "QuizWiz is fantastic! It offers a vast collection of quizzes on
                various topics, making it perfect for both casual fun and
                serious learning. The user-friendly interface and engaging
                format make it an excellent choice for anyone looking to expand
                their knowledge or challenge their friends."
              </p>
            </blockquote>
          ...
          <figure class="max-w-screen-md">
            ...
            <blockquote>
              <p class="font-semibold text-gray-700 dark:text-white">
                ...
                sharp. Highly recommend it for anyone who loves quizzes!"
              </p>
            </blockquote>
            <figcaption class="flex items-center mt-6 space-x-3 rtl:space-x-reverse">
              <img
